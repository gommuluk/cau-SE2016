...
public class FileManagerTest {
    ...
    public void setupTest () throws FileNotFoundException, UnsupportedEncodingException, LeftEditorFileCanNotCompareException, RightEditorFileCanNotCompareException
    {
        ...
        fileManager.loadFile("test files/AA.txt",FileManagerInterface.SideOfEditor.Left);
        fileManager.loadFile("test files/BB.txt",FileManagerInterface.SideOfEditor.Right);
